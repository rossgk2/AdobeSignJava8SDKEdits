...
/*     */     try {
/*  60 */       agreementsApi.getAuditTrail(ApiUtils.getNullAccessTokenHeaderParams(), 
/*  61 */           agreementId);
/*     */     }
...
/*     */     
/*     */     try {
/*  69 */       agreementsApi.getAuditTrail(ApiUtils.getEmptyAccessTokenHeaderParams(), 
/*  70 */           agreementId);
/*     */     }
...
/*     */     try {
/*  87 */       agreementsApi.getAuditTrail(ApiUtils.getEmptyXApiUserHeaderParams(), 
/*  88 */           agreementId);
/*     */     }
...
/*     */     try {
/* 105 */       agreementsApi.getAuditTrail(ApiUtils.getValidHeaderParams(), 
...
/*     */     
/*     */     try {
/* 114 */       agreementsApi.getAuditTrail(ApiUtils.getValidHeaderParams(), 
...
/*     */     try {
/* 129 */       byte[] audit = agreementsApi.getAuditTrail(ApiUtils.getValidHeaderParams(), 
/* 130 */           agreementId);
/* 131 */       Assert.assertNotNull(audit);
/*     */     }
/* 133 */     catch (ApiException e) {
/* 134 */       Assert.fail(ApiUtils.getMessage(e));
/*     */     } 
/*     */   }
/*     */ }


/* Location:              C:\Users\ross.grogankaylor\OneDrive - Perficient, Inc\Desktop\GigaSign1.3\RELEASE GIGASIGN\GigaSign_lib\ModifiedAdobeSDK-PROXY-OLD.jar!\com\adobe\sign\api\Agreements\GetAgreementAuditApiTest.class
